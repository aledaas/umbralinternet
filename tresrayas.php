...
<table width="100%" bgcolor="#9999CC" cellspacing="0" cellpadding="0"><tr><td align="center"><a href="tresrayas.php"><img src="ttt_php.gif" border="0" alt="Tic Tac Toe (in PHP)"></a></td></tr></table>
...
function genBox($size) {
   ...
   $count=0;
   $retVal='<form name="ttt" method="post" action="tresrayas.php">';
   for($i=0; $i<$size; $i++) {
      for($j=0; $j<$size; $j++) {
         $count++;
...
if($HTTP_POST_VARS) {
   ...
   if(playerWin()) {
      ...
      echo '<input type="button" onClick="location.href=\'tresrayas.php\'" value="Play Again!" style="background:#CCCCCC; font-weight:bold; cursor:hand"><br><br>';
      whereWinPlayer();
